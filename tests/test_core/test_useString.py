from usepy import useStringMiddleBatch, useStringMiddle, useStringLeft, useStringRight
...
def test_get_middle_batch():
    ...
    assert useStringMiddleBatch('abc123def456abc789def', end_str="def") == ['abc123', '456abc789']
    assert useStringMiddleBatch('abc123def456abc789def', start_str="abc") == ['123def456abc789def']
